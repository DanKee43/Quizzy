...
class MainMenu(MainFrameBase):
    def __init__(self, APP):
        ...
        CONNECT_btn = self.Menu_Button(self, text="Подключиться к игре",
        ...
        CREATE_ROOM_btn = self.Menu_Button(self, text="Создать игру",
        ...
        JOIN_btn = self.Menu_Button(self, text="Подключиться",
    ...
    def join_game(self, scene: str):
        if self.APP.IsAuth:
            if not self.APP.InGame:
